...
$$('#jasa').on('change', function () {
	 ...
	 if(jasa === 'servis'){
		 ...
		 $$('.biaya').text('Biaya tertera setelah pengecekan');
		  ...
		  $$('.biaya').text('Rp 30.000 - Rp 150.000');
	  }	 
	  else {
		$$('.biaya').text('Rp 75.000 - Rp 200.000');  
	  } 
 });
 ...
 $$('.pesan').on('click', function () {
	 ...
	 myApp.alert('Jasa: ' + jasa + ', Jenis AC:' + jenis + ', Unit:' + unit + ', Tanggal:' + tanggal + ', Waktu: ' + waktu + ', Alamat: ' + alamat + ', Layanan: ' + layanan + ', Pembayaran: ' + pembayaran);
 ...
 $$('.login-screen-embedded .list-button').on('click', function () {
       ...
       /*  myApp.alert('Username: ' + username + ', Password: ' + password, function () {
		...
		return;
			...
			var query = 'http://www.accalls.com/api/v1/login';
			//myApp.showIndicator();
			myApp.showPreloader();
			$$.ajax({
				   type: 'POST',
 ...
 // Register	
	...
	$$('.card-login-area .button-register').on('click', function () {
		...
		return;
			...
			var query = 'http://www.accalls.com/api/v1/register';
			//myApp.showIndicator();
			myApp.showPreloader();
			$$.ajax({
				   type: 'POST',
